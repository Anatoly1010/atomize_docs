...
5. S. A. Dzuba, **J. Magn. Reson.** *2016*, 269, 1. [10.1016/j.jmr.2016.06.001](https://doi.org/10.1016/j.jmr.2016.06.001) — Monte-Carlo (Pake-doublet) solver for the Gaussian engine (`method='mc'`).
6. A. G. Matveeva *et al.*, **Z. Phys. Chem.** *2017*, 231, 463. [10.1515/zpch-2016-0830](https://doi.org/10.1515/zpch-2016-0830) — Monte-Carlo Gaussian inversion.
